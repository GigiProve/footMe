...
type CoachExperienceBlockProps = {
  group: CoachGroupedExperience;
  isLast: boolean;
  isOwner: boolean;
...
export function CoachExperienceBlock({
  group,
  isLast,
  isOwner,
  onDelete,
  onEdit,
}: CoachExperienceBlockProps) {
  return (
        ...
        <View style={styles.head}>
          ...
          {isOwner ? (
            <View style={styles.actions}>
              <Pressable
                accessibilityLabel="Modifica esperienza da allenatore"
              ...
              <Pressable
                accessibilityLabel="Elimina esperienza da allenatore"
                accessibilityRole="button"
                hitSlop={8}

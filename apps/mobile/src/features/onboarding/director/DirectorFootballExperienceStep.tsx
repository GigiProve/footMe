...
import { DIRECTOR_EXTRA_FOOTBALL_ROLE_OPTIONS } from "../onboarding-types";

type DirectorFootballExperienceStepProps = {
...
export function DirectorFootballExperienceStep({
  ...
  onToggleExperience,
  onUpdateRoles,
}: DirectorFootballExperienceStepProps) {
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <AppText variant="bodySm" color="secondary">
          Hai ricoperto altri ruoli nel mondo del calcio?
        </AppText>
      </View>
        ...
        {hasOtherFootballExperience ? (
          <View style={styles.fieldGroup}>
            ...
            <View style={styles.chips}>
              {DIRECTOR_EXTRA_FOOTBALL_ROLE_OPTIONS.map((option) => {

-- Add availability_type and transfer_provinces to player_profiles.
-- availability_type indicates geographic scope: ITALY, REGIONS, or PROVINCES.
-- transfer_provinces stores specific province-level availability.

alter table public.player_profiles
add column if not exists availability_type text not null default 'ITALY',
add column if not exists transfer_provinces text[] not null default '{}';
